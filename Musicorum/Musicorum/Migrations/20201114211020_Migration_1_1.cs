...
{
    public partial class Migration_1_1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TitlePhoto = table.Column<byte[]>(maxLength: 5242880, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Chorus = table.Column<string>(nullable: true),
                    ...
                    Photo = table.Column<byte[]>(maxLength: 5242880, nullable: true),
                    SongAsBytes = table.Column<byte[]>(maxLength: 5242880, nullable: false),
                    Title = table.Column<string>(nullable: false),
                    UserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhotoAsBytes = table.Column<byte[]>(maxLength: 5242880, nullable: false),
